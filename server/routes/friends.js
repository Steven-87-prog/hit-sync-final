...
const { load, save, nextId, publicUser, addNotification, userDistance, getRatingSummary, overlappingBlocks } = require("../utils");
...
router.get("/", requireAuth, (req, res) => {
  ...
  const friends = data.users
    ...
    .map((u) => {
      ...
      return {
        ...publicUser(u),
        distance: userDistance(me, u),
        ...getRatingSummary(data, u.id),
        overlappingTimes,
